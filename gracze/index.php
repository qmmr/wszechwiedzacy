<?php
    ...
    switch ($cufq) {
	    case ($cufq >= 10 && $cufq < 50):$level = "kapujący";$stars = 2;break;
	    case ($cufq >= 50 && $cufq < 100):$level = "ogarniacz";$stars = 3;break;
	    case ($cufq >= 100 && $cufq < 250):$level = "tęgogłowy";$stars = 4;break;
	    case ($cufq >= 250 && $cufq < 500):$level = "moozg";$stars = 5;break;
	    case ($cufq >= 500 && $cufq < 1000):$level = "przegość";$stars = 6;break;
	    case ($cufq >= 1000):$level = "wszechwiedzacy";$stars = 7;break;
	    default:$level = "początkujący";break;
    }
...
<div id="mainContent">
	...
	<p class="poziom" title="<?php echo $level; ?>">Poziom:
		...
		<?php
		    ...
		    switch($stars) {
				case 2:echo $show_star.$show_star;break;
				case 3:echo $show_star.$show_star.$show_star;break;
				case 4:echo $show_star.$show_star.$show_star.$show_star;break;
				case 5:echo $show_star.$show_star.$show_star.$show_star.$show_star;break;
				case 6:echo $show_star.$show_star.$show_star.$show_star.$show_star.$show_star;break;
				case 7:echo $show_star.$show_star.$show_star.$show_star.$show_star.$show_star.$show_star;break;
				default:echo $show_star;break;
		    }
		?>
		</div>
	</p>
	...
	<form id="profile_form" method="post" action="">
		...
		<span class="info">pokazuj ile masz lat</span>
	    </div>
		...
		<span class="info">Wiadomości na email?</span>
	    </div>

	    <p class="password">Zmiana hasła</p>
	    <p class="info">Jeśli nie chcesz zmieniać hasła, pozostaw puste pola</p>
