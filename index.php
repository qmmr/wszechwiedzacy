...
<div id="mainContent">
    ...
    <div id="slider">
        <a href="<?= SITE_URL; ?>"><img src="<?= SITE_URL; ?>images/slides/slide_1.jpg" alt="http://wszechwiedzacy.pl" /></a>
        <a href="<?= SITE_URL; ?>gra"><img src="<?= SITE_URL; ?>images/slides/slide_2.png" alt="Cechy gry wszechwiedzacy.pl" /></a>
        <a href="<?= SITE_URL; ?>gra"><img src="<?= SITE_URL; ?>images/slides/slide_3.png" alt="Zacznij grać już teraz!" /></a>
        <a href="<?= SITE_URL; ?>ranking"><img src="<?= SITE_URL; ?>images/slides/slide_4.png" alt="Sprawdź ranking!" /></a>
    </div>
