...
var wszechwiedzacy = {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (data.user == "valid" && data.password == "valid" && data.email == "sent" && data.mysql == "valid" && data.recaptcha == "valid") {
                                    ...
                                    if (data.email == "error") {
                                        alert("Przepraszamy! Wystąpił błąd podczas rejestracji i email z kluczem potwierdzającym nie został wysłany. Aby aktywować konto proszę skontaktować się z nami pod adresem kontakt@wszechwiedzacy.pl");
                                    }
                                    if (data.mysql != "valid") {
                                        alert("Oops! Wystąpił błąd podczas przetwarzania informacji w bazie MySQL, spróbuj jeszcze raz lub skontaktuj się z nami pod adresem kontakt@wszechwiedzacy.cpl");
                                    }
    ...
    gra: {
        // if its true instead of real game we will tour guide
        tutorialMode: false,
        ...
        setButtons: function () {
            ...
            $("button").each(function () {
                ...
                $(this).click(function (e) {
                    ...
                    switch (cb.attr("id")) {
                        ...
                        case "start":
                            $("#startWrap").remove();                            
                            //alert("tutorial mode "+wszechwiedzacy.gra.tutorialMode);
                            wszechwiedzacy.gra.showNextQuestion();                 
                            break;
                        ...
                        case "submitButton":
                            ...
                            // tutorial
                            //if(wszechwiedzacy.gra.tutorialMode) {
                            //    var url = wszechwiedzacy.site_url + "gra/odpowiedz_tutorial.php";
                            //} else {
                            //    var url = wszechwiedzacy.site_url + "gra/odpowiedz.php";
                            //}
                            ...
                            $.ajax({                                
                                ...
                                success: function (data) {
                                    ...
                                    switch (game) {
                                        ...
                                        case "advance":
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (data) {
                                                    ...
                                                    //var paragraphs = $("div.resultsHolder > p").hide();
                                                    //wszechwiedzacy.gra.cdnum = 0;
                                                    //var ch = setTimeout("wszechwiedzacy.gra.countdown()", 1000);
                                                    //paragraphs.each(function(){                                               
                                                    //   //$(this).fadeIn(300);
                                                    //});
                                                    //function countDown() {
                                                    //    paragraphs.eq(counter).fadeIn(500);
                                                    //    counter++;
                                                    //    if(counter == paragraphs.length()) {
                                                    //        clearTimeout(wszechwiedzacy.gra.countdown);
                                                    //        alert("finished");
                                                    //    } else {
                                                    //        setTimeout("wszechwiedzacy.gra.countdown()", 1000);
                                                    //    }
                                                    //}
                                                },
                                                error: function (XMLHttpRequest, textStatus, errorThrown) {
                                        ...
                                        case "tutorial":
                                            // tutorial has been disabled for now, images are shown
                                            //alert("tutorial!");
                                            wszechwiedzacy.gra.showNextQuestion();
                                            break;
                        ...
                        case "wprowadzenie":
                            // tutorial has been disabled for no
                            wszechwiedzacy.gra.tutorialMode = true;
                            $("#startWrap").hide();
                            //alert("tutorial mode "+wszechwiedzacy.gra.tutorialMode);
                            //wszechwiedzacy.gra.showNextQuestion();
            ...
            }).hover(hoverO, hoverT).mouseup(mUp).mousedown(mDown); // end each function
        ...
        showNextQuestion: function () {
            $("#loaderContainer").fadeIn(500); // show the animation gif
            clearInterval(wszechwiedzacy.time.newInt);
            
            // tutorial mode has been disabled for now
            //if(wszechwiedzacy.gra.tutorialMode) {
            //    // tutorial mode is ON so we load tutorial question
            //    var url = wszechwiedzacy.site_url + "gra/pytanie_tutorial.php";
            //} else {
            //    // tutorial mode is OFF so we load normal question
    ...
    time: {
        ...
        tutorial: function() {
            // tutorial has been disabled for now
            //alert("tutorial");
            //var c = setTimeout(function(){alert("Tak, nie mylisz się, trzeba zaznaczyć 2 :)")}, 7000);            
        }
